    ...
    return(
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
             <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-log hover:scale-105 duration-300">
              ...
              <div>
                <p className='py-2 border-b mx-8 mt-8'>I Granted User</p>
                <p className='py-2 border-b mx-8 '>500 GB Storage</p>
                <p className='py-2 border-b mx-8 '>Send up to 2 GB</p>
              </div>
              <button className='bg-[#00df9a] w-[200px] rounded-md font-medium mx-4 my-6 px-6 py-3 text-black'>Start trial</button>
               </div>
              ...
              <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium mx-4 my-6 px-6 py-3 '>Start trial</button>
               </div>
